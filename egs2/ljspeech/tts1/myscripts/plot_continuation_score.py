...
def plot(axes, df, num):
    ...
    for i, (setting, values) in enumerate(value_dict.items()):
        N = setting.split("-")[0]
        x = values["bitrate"]
        y = values["PPL"]
        ax.plot(
    ...
    if num == 0:
        ...
        ax.set_xticklabels([0, 1, 2, 3, 4, 5], minor=False)
    elif num == 1:
        ax.set_xlim(0, 600)
...
if __name__ == "__main__":
    ...
    fig.savefig("./fig/continuation_score.pdf")
